/* gate.js
 *
 * Client-side, code-based access gate for protected pages on benow.us.
 ...
 * https://benow.us/p/<name>/#code=THECODE (a bare #THECODE also works).
...
(function () {
  ...
  var STORAGE_KEY = "benow-code:" + location.pathname;
  ...
  function buildPrompt() {
    ...
    wrap.innerHTML =
      ...
      '<p class="brand">benow<em>.us</em></p>' +
